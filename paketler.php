        ...
        <div class="content-body">
            <section id="pricing-plan">
                <div class="text-center">
                    <h1 class="mt-2">UwU Üyelik Paketleri</h1>
                    <p class="mb-2 pb-75">
                            ...
                            <div class="accordion accordion-margin" id="accordionExample">
                                <div class="card accordion-item">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            ...
                                            Fakat <a href="https://discord.gg/uwucheck" target="_blank">Discord</a> sunucumuza gelip bizlere ulaşarak, böyle bir ödeme yöntemini
                                ...
                                <div class="card accordion-item">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            Böyle bir şey ne yazık ki söz konusu değildir. UwU yetkilisi olduğunu iddia eden kişilerle iletişim kurmayınız, sadece web sitemiz üzerinden destek alınız.
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    {
        window.location = 'https://discord.gg/uwucheck';
        return false;
    }
</script>
